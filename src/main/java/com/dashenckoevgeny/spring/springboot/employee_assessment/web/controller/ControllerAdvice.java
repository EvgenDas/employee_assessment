...
import com.dashenckoevgeny.spring.springboot.employee_assessment.domain.exception.ExceptionBody;
...
public class ControllerAdvice {
  ...
  public ExceptionBody handleMethodArgumentNotValid(MethodArgumentNotValidException e) {
    ExceptionBody exceptionBody = new ExceptionBody("Validate failed.");
